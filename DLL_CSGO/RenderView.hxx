...
public:
    ...
    virtual void			BuildWorldLists( IWorldRenderList *pList , WorldListInfo_t* pInfo , int iForceFViewLeaf , const VisOverrideData_t* pVisData , bool bShadowDepth , float *pReflectionWaterHeight ) = 0;
    ...
    // Sets the main view
    virtual void			SetMainView( const Vector &vecOrigin , const Angle &angles ) = 0;
    ...
    virtual void			DrawBrushModelShadowDepth( IClientEntity *baseentity , model_t *model , const Vector& origin , const Angle& angles , ERenderDepthMode DepthMode ) = 0;
    ...
    virtual void			DrawBrushModelEx( IClientEntity *baseentity , model_t *model , const Vector& origin , const Angle& angles , DrawBrushModelMode_t mode ) = 0;
};
