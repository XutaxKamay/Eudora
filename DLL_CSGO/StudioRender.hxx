...
struct StudioModelArrayInfo2_t
{
    ...
    Pointer	                m_pFlashlights;	// NOTE: Can have at most MAX_FLASHLIGHTS_PER_INSTANCE_DRAW_CALL of these
};
...
public:
    ...
    virtual void AddDecal( StudioDecalHandle_t handle , studiohdr_t *pStudioHdr , Matrix3x4 *pBoneToWorld ,
                           const Ray & ray , const Vector& decalUp , IMaterial* pDecalMaterial , float radius , int body , bool noPokethru = false , int maxLODToDecal = ADDDECAL_TO_ALL_LODS ) = 0;
    ...
    virtual void AddShadow( IMaterial* pMaterial , void* pProxyData , Pointer m_pFlashlightState = NULL , VMatrix *pWorldToTexture = NULL , ITexture *pFlashlightDepthTexture = NULL ) = 0;
