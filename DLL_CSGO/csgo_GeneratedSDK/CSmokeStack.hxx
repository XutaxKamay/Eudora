...
#ifndef SDK_CSmokeStack
#define SDK_CSmokeStack
#pragma once
 ...
 public:
   ...
   class DT_SmokeStack
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T SpreadSpeed() { return ( T ) 0xB14; }
      template<typename T = unsigned long> __forceinline static T Speed() { return ( T ) 0xB18; }
      template<typename T = unsigned long> __forceinline static T StartSize() { return ( T ) 0xB1C; }
      template<typename T = unsigned long> __forceinline static T EndSize() { return ( T ) 0xB20; }
      template<typename T = unsigned long> __forceinline static T Rate() { return ( T ) 0xB24; }
      template<typename T = unsigned long> __forceinline static T JetLength() { return ( T ) 0xB28; }
      template<typename T = unsigned long> __forceinline static T bEmit() { return ( T ) 0xB2C; }
      template<typename T = unsigned long> __forceinline static T flBaseSpread() { return ( T ) 0xB30; }
      template<typename T = unsigned long> __forceinline static T flTwist() { return ( T ) 0xB84; }
      template<typename T = unsigned long> __forceinline static T flRollSpeed() { return ( T ) 0xBC0; }
      template<typename T = unsigned long> __forceinline static T iMaterialModel() { return ( T ) 0xB88; }
      template<typename T = unsigned long> __forceinline static T AmbientLight_vPos() { return ( T ) 0xB34; }
      template<typename T = unsigned long> __forceinline static T AmbientLight_vColor() { return ( T ) 0xB40; }
      template<typename T = unsigned long> __forceinline static T AmbientLight_flIntensity() { return ( T ) 0xB4C; }
      template<typename T = unsigned long> __forceinline static T DirLight_vPos() { return ( T ) 0xB50; }
      template<typename T = unsigned long> __forceinline static T DirLight_vColor() { return ( T ) 0xB5C; }
      template<typename T = unsigned long> __forceinline static T DirLight_flIntensity() { return ( T ) 0xB68; }
      template<typename T = unsigned long> __forceinline static T vWind() { return ( T ) 0xB78; }
   };
};
