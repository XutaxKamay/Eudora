...
#ifndef SDK_CPointWorldText
#define SDK_CPointWorldText
#pragma once
 ...
 public:
   ...
   class DT_PointWorldText
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T szText() { return ( T ) 0xA08; }
      template<typename T = unsigned long> __forceinline static T flTextSize() { return ( T ) 0xB0C; }
      template<typename T = unsigned long> __forceinline static T textColor() { return ( T ) 0xB10; }
   };
};
