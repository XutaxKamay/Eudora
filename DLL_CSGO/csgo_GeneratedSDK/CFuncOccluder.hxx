...
#ifndef SDK_CFuncOccluder
#define SDK_CFuncOccluder
#pragma once
 ...
 public:
   ...
   class DT_FuncOccluder
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bActive() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T nOccluderIndex() { return ( T ) 0x9D8; }
   };
};
