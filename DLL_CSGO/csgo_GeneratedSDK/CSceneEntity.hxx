...
#ifndef SDK_CSceneEntity
#define SDK_CSceneEntity
#pragma once
 ...
 public:
   ...
   class DT_SceneEntity
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nSceneStringIndex() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T bIsPlayingBack() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T bPaused() { return ( T ) 0x9DD; }
      template<typename T = unsigned long> __forceinline static T bMultiplayer() { return ( T ) 0x9DE; }
      template<typename T = unsigned long> __forceinline static T flForceClientTime() { return ( T ) 0x9E4; }
      ...
      class _ST_m_hActorList_16
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T _000() { return ( T ) 0x9F4; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_000() { return ( T ) 0x9F4; }
         template<typename T = unsigned long> __forceinline static T _001() { return ( T ) 0x13E8; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_001() { return ( T ) 0x13E8; }
         template<typename T = unsigned long> __forceinline static T _002() { return ( T ) 0x1DDC; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_002() { return ( T ) 0x1DDC; }
         template<typename T = unsigned long> __forceinline static T _003() { return ( T ) 0x27D0; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_003() { return ( T ) 0x27D0; }
         template<typename T = unsigned long> __forceinline static T _004() { return ( T ) 0x31C4; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_004() { return ( T ) 0x31C4; }
         template<typename T = unsigned long> __forceinline static T _005() { return ( T ) 0x3BB8; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_005() { return ( T ) 0x3BB8; }
         template<typename T = unsigned long> __forceinline static T _006() { return ( T ) 0x45AC; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_006() { return ( T ) 0x45AC; }
         template<typename T = unsigned long> __forceinline static T _007() { return ( T ) 0x4FA0; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_007() { return ( T ) 0x4FA0; }
         template<typename T = unsigned long> __forceinline static T _008() { return ( T ) 0x5994; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_008() { return ( T ) 0x5994; }
         template<typename T = unsigned long> __forceinline static T _009() { return ( T ) 0x6388; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_009() { return ( T ) 0x6388; }
         template<typename T = unsigned long> __forceinline static T _010() { return ( T ) 0x6D7C; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_010() { return ( T ) 0x6D7C; }
         template<typename T = unsigned long> __forceinline static T _011() { return ( T ) 0x7770; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_011() { return ( T ) 0x7770; }
         template<typename T = unsigned long> __forceinline static T _012() { return ( T ) 0x8164; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_012() { return ( T ) 0x8164; }
         template<typename T = unsigned long> __forceinline static T _013() { return ( T ) 0x8B58; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_013() { return ( T ) 0x8B58; }
         template<typename T = unsigned long> __forceinline static T _014() { return ( T ) 0x954C; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_014() { return ( T ) 0x954C; }
         template<typename T = unsigned long> __forceinline static T _015() { return ( T ) 0x9F40; }
         template<typename T = unsigned long> __forceinline static T _ST_hActorList_16_015() { return ( T ) 0x9F40; }
      };
   };
};
