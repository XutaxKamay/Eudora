...
#ifndef SDK_CAI_BaseNPC
#define SDK_CAI_BaseNPC
#pragma once
 ...
 public:
   ...
   class DT_AI_BaseNPC
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bPerformAvoidance() { return ( T ) 0x2F14; }
      template<typename T = unsigned long> __forceinline static T bIsMoving() { return ( T ) 0x2F15; }
      template<typename T = unsigned long> __forceinline static T bFadeCorpse() { return ( T ) 0x2F16; }
      template<typename T = unsigned long> __forceinline static T iDeathPose() { return ( T ) 0x2F04; }
      template<typename T = unsigned long> __forceinline static T iDeathFrame() { return ( T ) 0x2F08; }
      template<typename T = unsigned long> __forceinline static T iSpeedModRadius() { return ( T ) 0x2F0C; }
      template<typename T = unsigned long> __forceinline static T iSpeedModSpeed() { return ( T ) 0x2F10; }
      template<typename T = unsigned long> __forceinline static T bSpeedModActive() { return ( T ) 0x2F17; }
      template<typename T = unsigned long> __forceinline static T bImportanRagdoll() { return ( T ) 0x2F18; }
      template<typename T = unsigned long> __forceinline static T flTimePingEffect() { return ( T ) 0x2F00; }
   };
};
