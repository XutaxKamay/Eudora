...
#ifndef SDK_CEnvScreenEffect
#define SDK_CEnvScreenEffect
#pragma once
 ...
 public:
   ...
   class DT_EnvScreenEffect
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flDuration() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T nType() { return ( T ) 0x9DC; }
   };
};
