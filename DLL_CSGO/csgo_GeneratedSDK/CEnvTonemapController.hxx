...
#ifndef SDK_CEnvTonemapController
#define SDK_CEnvTonemapController
#pragma once
 ...
 public:
   ...
   class DT_EnvTonemapController
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bUseCustomAutoExposureMin() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bUseCustomAutoExposureMax() { return ( T ) 0x9D9; }
      template<typename T = unsigned long> __forceinline static T bUseCustomBloomScale() { return ( T ) 0x9DA; }
      template<typename T = unsigned long> __forceinline static T flCustomAutoExposureMin() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T flCustomAutoExposureMax() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T flCustomBloomScale() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T flCustomBloomScaleMinimum() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T flBloomExponent() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flBloomSaturation() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T flTonemapPercentTarget() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T flTonemapPercentBrightPixels() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T flTonemapMinAvgLum() { return ( T ) 0x9FC; }
      template<typename T = unsigned long> __forceinline static T flTonemapRate() { return ( T ) 0xA00; }
   };
};
