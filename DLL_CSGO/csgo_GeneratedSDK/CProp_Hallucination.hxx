...
#ifndef SDK_CProp_Hallucination
#define SDK_CProp_Hallucination
#pragma once
 ...
 public:
   ...
   class DT_Prop_Hallucination
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bEnabled() { return ( T ) 0x2989; }
      template<typename T = unsigned long> __forceinline static T fVisibleTime() { return ( T ) 0x298C; }
      template<typename T = unsigned long> __forceinline static T fRechargeTime() { return ( T ) 0x2990; }
   };
};
