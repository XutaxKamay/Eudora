...
#ifndef SDK_CIncendiaryGrenade
#define SDK_CIncendiaryGrenade
#pragma once
...
class CIncendiaryGrenade
{
 public:
   ...
   class DT_IncendiaryGrenade
   {
    public:

      class DT_MolotovGrenade
      {
       public:

         class DT_BaseCSGrenade
         {
          public:
            ...
            template<typename T = unsigned long> __forceinline static T bRedraw() { return ( T ) 0x3360; }
            template<typename T = unsigned long> __forceinline static T bIsHeldByPlayer() { return ( T ) 0x3361; }
            template<typename T = unsigned long> __forceinline static T bPinPulled() { return ( T ) 0x3362; }
            template<typename T = unsigned long> __forceinline static T fThrowTime() { return ( T ) 0x3364; }
            template<typename T = unsigned long> __forceinline static T bLoopingSoundPlaying() { return ( T ) 0x3368; }
            template<typename T = unsigned long> __forceinline static T flThrowStrength() { return ( T ) 0x336C; }
         };
      };
   };
};
