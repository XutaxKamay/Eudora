...
#ifndef SDK_CEntityDissolve
#define SDK_CEntityDissolve
#pragma once
 ...
 public:
   ...
   class DT_EntityDissolve
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flFadeOutStart() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T flFadeOutLength() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T flFadeOutModelStart() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T flFadeOutModelLength() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flFadeInStart() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T flFadeInLength() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T nDissolveType() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T vDissolverOrigin() { return ( T ) 0xA00; }
      template<typename T = unsigned long> __forceinline static T nMagnitude() { return ( T ) 0xA0C; }
   };
};
