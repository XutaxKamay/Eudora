...
#ifndef SDK_CItemAssaultSuitUseable
#define SDK_CItemAssaultSuitUseable
#pragma once
...
class CItemAssaultSuitUseable
{
 public:
   ...
   class DT_ItemAssaultSuitUseable
   {
    public:
      ...
      class DT_Item
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T bShouldGlow() { return ( T ) 0x3204; }
      };

      template<typename T = unsigned long> __forceinline static T nArmorValue() { return ( T ) 0x3410; }
      template<typename T = unsigned long> __forceinline static T bIsHeavyAssaultSuit() { return ( T ) 0x3414; }
   };
};
