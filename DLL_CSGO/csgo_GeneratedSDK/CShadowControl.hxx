...
#ifndef SDK_CShadowControl
#define SDK_CShadowControl
#pragma once
 ...
 public:
   ...
   class DT_ShadowControl
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T shadowColor() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T flShadowMaxDist() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T bDisableShadows() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T bEnableLocalLightShadows() { return ( T ) 0x9ED; }
   };
};
