...
#ifndef SDK_CEnvScreenOverlay
#define SDK_CEnvScreenOverlay
#pragma once
 ...
 public:
   ...
   class DT_EnvScreenOverlay
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T iszOverlayNames_0() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T flOverlayTimes_0() { return ( T ) 0x13D0; }
      template<typename T = unsigned long> __forceinline static T flStartTime() { return ( T ) 0x13F8; }
      template<typename T = unsigned long> __forceinline static T iDesiredOverlay() { return ( T ) 0x13FC; }
      template<typename T = unsigned long> __forceinline static T bIsActive() { return ( T ) 0x1400; }
   };
};
