...
#ifndef SDK_CEntityFlame
#define SDK_CEntityFlame
#pragma once
 ...
 public:
   ...
   class DT_EntityFlame
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T hEntAttached() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bCheapEffect() { return ( T ) 0x9EC; }
   };
};
