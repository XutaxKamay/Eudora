...
#ifndef SDK_CStatueProp
#define SDK_CStatueProp
#pragma once
    ...
    public:
      ...
      class DT_PhysicsProp
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T bAwake() { return ( T ) 0x2990; }
         template<typename T = unsigned long> __forceinline static T spawnflags() { return ( T ) 0x2C4; }
      };

      template<typename T = unsigned long> __forceinline static T hInitBaseAnimating() { return ( T ) 0x29B0; }
      template<typename T = unsigned long> __forceinline static T bShatter() { return ( T ) 0x29B4; }
      template<typename T = unsigned long> __forceinline static T nShatterFlags() { return ( T ) 0x29B8; }
      template<typename T = unsigned long> __forceinline static T vShatterPosition() { return ( T ) 0x29BC; }
      template<typename T = unsigned long> __forceinline static T vShatterForce() { return ( T ) 0x29C8; }
   };
};
