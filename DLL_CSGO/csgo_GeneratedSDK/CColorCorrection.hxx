...
#ifndef SDK_CColorCorrection
#define SDK_CColorCorrection
#pragma once
 ...
 public:
   ...
   class DT_ColorCorrection
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T vecOrigin() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T minFalloff() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T maxFalloff() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T flCurWeight() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T flMaxWeight() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T flFadeInDuration() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flFadeOutDuration() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T netLookupFilename() { return ( T ) 0x9FC; }
      template<typename T = unsigned long> __forceinline static T bEnabled() { return ( T ) 0xB00; }
      template<typename T = unsigned long> __forceinline static T bMaster() { return ( T ) 0xB01; }
      template<typename T = unsigned long> __forceinline static T bClientSide() { return ( T ) 0xB02; }
      template<typename T = unsigned long> __forceinline static T bExclusive() { return ( T ) 0xB03; }
   };
};
