...
#ifndef SDK_CTriggerSoundOperator
#define SDK_CTriggerSoundOperator
#pragma once
 ...
 public:
   ...
   class DT_TriggerSoundOperator
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nSoundOperator() { return ( T ) 0xA10; }
   };
};
