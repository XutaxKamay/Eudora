...
#ifndef SDK_RocketTrail
#define SDK_RocketTrail
#pragma once
 ...
 public:
   ...
   class DT_RocketTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T StartSize() { return ( T ) 0xAF4; }
      template<typename T = unsigned long> __forceinline static T EndSize() { return ( T ) 0xAF8; }
      template<typename T = unsigned long> __forceinline static T SpawnRadius() { return ( T ) 0xAFC; }
      template<typename T = unsigned long> __forceinline static T bEmit() { return ( T ) 0xB0C; }
      template<typename T = unsigned long> __forceinline static T nAttachment() { return ( T ) 0xB10; }
      template<typename T = unsigned long> __forceinline static T Opacity() { return ( T ) 0xAE0; }
      template<typename T = unsigned long> __forceinline static T bDamaged() { return ( T ) 0xB0D; }
      template<typename T = unsigned long> __forceinline static T flFlareScale() { return ( T ) 0xB20; }
   };
};
