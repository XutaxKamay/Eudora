 ...
 public:
   ...
   class DT_WeaponC4
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bStartedArming() { return ( T ) 0x3390; }
      template<typename T = unsigned long> __forceinline static T bBombPlacedAnimation() { return ( T ) 0x3398; }
      template<typename T = unsigned long> __forceinline static T fArmedTime() { return ( T ) 0x3394; }
      template<typename T = unsigned long> __forceinline static T bShowC4LED() { return ( T ) 0x3399; }
      template<typename T = unsigned long> __forceinline static T bIsPlantingViaUse() { return ( T ) 0x339A; }
   };
};
