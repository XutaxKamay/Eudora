...
#ifndef SDK_SporeTrail
#define SDK_SporeTrail
#pragma once
 ...
 public:
   ...
   class DT_SporeTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flSpawnRate() { return ( T ) 0xACC; }
      template<typename T = unsigned long> __forceinline static T vecEndColor() { return ( T ) 0xAC0; }
      template<typename T = unsigned long> __forceinline static T flParticleLifetime() { return ( T ) 0xAD0; }
      template<typename T = unsigned long> __forceinline static T flStartSize() { return ( T ) 0xAD4; }
      template<typename T = unsigned long> __forceinline static T flEndSize() { return ( T ) 0xAD8; }
      template<typename T = unsigned long> __forceinline static T flSpawnRadius() { return ( T ) 0xADC; }
      template<typename T = unsigned long> __forceinline static T bEmit() { return ( T ) 0xAEC; }
   };
};
