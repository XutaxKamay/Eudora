...
#ifndef SDK_CItem_Healthshot
#define SDK_CItem_Healthshot
#pragma once
...
class CItem_Healthshot
{
 public:
   ...
   class DT_Item_Healthshot
   {
    public:

      class DT_WeaponBaseItem
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T bRedraw() { return ( T ) 0x336C; }
      };
   };
};
