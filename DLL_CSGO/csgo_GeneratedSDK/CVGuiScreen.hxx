...
#ifndef SDK_CVGuiScreen
#define SDK_CVGuiScreen
#pragma once
 ...
 public:
   ...
   class DT_VGuiScreen
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flWidth() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T flHeight() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T fScreenFlags() { return ( T ) 0xA0C; }
      template<typename T = unsigned long> __forceinline static T nPanelName() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T nAttachmentIndex() { return ( T ) 0xA04; }
      template<typename T = unsigned long> __forceinline static T nOverlayMaterial() { return ( T ) 0xA08; }
      template<typename T = unsigned long> __forceinline static T hPlayerOwner() { return ( T ) 0xA68; }
   };
};
