...
#ifndef SDK_CSpriteTrail
#define SDK_CSpriteTrail
#pragma once
    ...
    public:
      ...
      class DT_Sprite
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T hAttachedToEntity() { return ( T ) 0x9E8; }
         template<typename T = unsigned long> __forceinline static T nAttachment() { return ( T ) 0x9EC; }
         template<typename T = unsigned long> __forceinline static T flScaleTime() { return ( T ) 0xA08; }
         template<typename T = unsigned long> __forceinline static T flSpriteScale() { return ( T ) 0xA04; }
         template<typename T = unsigned long> __forceinline static T flSpriteFramerate() { return ( T ) 0x9F0; }
         template<typename T = unsigned long> __forceinline static T flGlowProxySize() { return ( T ) 0xA10; }
         template<typename T = unsigned long> __forceinline static T flHDRColorScale() { return ( T ) 0xA14; }
         template<typename T = unsigned long> __forceinline static T flFrame() { return ( T ) 0x9F4; }
         template<typename T = unsigned long> __forceinline static T flBrightnessTime() { return ( T ) 0xA00; }
         template<typename T = unsigned long> __forceinline static T nBrightness() { return ( T ) 0x9FC; }
         template<typename T = unsigned long> __forceinline static T bWorldSpaceScale() { return ( T ) 0xA0C; }
      };

      template<typename T = unsigned long> __forceinline static T flLifeTime() { return ( T ) 0x1074; }
      template<typename T = unsigned long> __forceinline static T flStartWidth() { return ( T ) 0x1078; }
      template<typename T = unsigned long> __forceinline static T flEndWidth() { return ( T ) 0x107C; }
      template<typename T = unsigned long> __forceinline static T flStartWidthVariance() { return ( T ) 0x1080; }
      template<typename T = unsigned long> __forceinline static T flTextureRes() { return ( T ) 0x1084; }
      template<typename T = unsigned long> __forceinline static T flMinFadeLength() { return ( T ) 0x1088; }
      template<typename T = unsigned long> __forceinline static T vecSkyboxOrigin() { return ( T ) 0x108C; }
      template<typename T = unsigned long> __forceinline static T flSkyboxScale() { return ( T ) 0x1098; }
   };
};
