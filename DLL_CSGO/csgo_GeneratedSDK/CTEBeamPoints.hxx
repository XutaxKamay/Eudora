...
#ifndef SDK_CTEBeamPoints
#define SDK_CTEBeamPoints
#pragma once
 ...
 public:
   ...
   class DT_TEBeamPoints
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T vecStartPoint() { return ( T ) 0x4C; }
      template<typename T = unsigned long> __forceinline static T vecEndPoint() { return ( T ) 0x58; }
   };
};
