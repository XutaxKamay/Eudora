...
#ifndef SDK_CSpotlightEnd
#define SDK_CSpotlightEnd
#pragma once
 ...
 public:
   ...
   class DT_SpotlightEnd
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flLightScale() { return ( T ) 0x9D8; }
