...
#ifndef SDK_CFootstepControl
#define SDK_CFootstepControl
#pragma once
 ...
 public:
   ...
   class DT_FootstepControl
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T source() { return ( T ) 0xA10; }
      template<typename T = unsigned long> __forceinline static T destination() { return ( T ) 0xA20; }
   };
};
