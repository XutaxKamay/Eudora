...
#ifndef SDK_CEnvProjectedTexture
#define SDK_CEnvProjectedTexture
#pragma once
 ...
 public:
   ...
   class DT_EnvProjectedTexture
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T hTargetEntity() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T bState() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T bAlwaysUpdate() { return ( T ) 0x9E1; }
      template<typename T = unsigned long> __forceinline static T flLightFOV() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T bEnableShadows() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T bSimpleProjection() { return ( T ) 0x9E9; }
      template<typename T = unsigned long> __forceinline static T bLightOnlyTarget() { return ( T ) 0x9EA; }
      template<typename T = unsigned long> __forceinline static T bLightWorld() { return ( T ) 0x9EB; }
      template<typename T = unsigned long> __forceinline static T bCameraSpace() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flBrightnessScale() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T LightColor() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T flColorTransitionTime() { return ( T ) 0xA08; }
      template<typename T = unsigned long> __forceinline static T flAmbient() { return ( T ) 0xA0C; }
      template<typename T = unsigned long> __forceinline static T SpotlightTextureName() { return ( T ) 0xA18; }
      template<typename T = unsigned long> __forceinline static T nSpotlightTextureFrame() { return ( T ) 0xB24; }
      template<typename T = unsigned long> __forceinline static T flNearZ() { return ( T ) 0xA10; }
      template<typename T = unsigned long> __forceinline static T flFarZ() { return ( T ) 0xA14; }
      template<typename T = unsigned long> __forceinline static T nShadowQuality() { return ( T ) 0xB28; }
      template<typename T = unsigned long> __forceinline static T flProjectionSize() { return ( T ) 0xB38; }
      template<typename T = unsigned long> __forceinline static T flRotation() { return ( T ) 0xB3C; }
      template<typename T = unsigned long> __forceinline static T iStyle() { return ( T ) 0xB2C; }
   };
};
