...
#ifndef SDK_ParticleSmokeGrenade
#define SDK_ParticleSmokeGrenade
#pragma once
 ...
 public:
   ...
   class DT_ParticleSmokeGrenade
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flSpawnTime() { return ( T ) 0xAD4; }
      template<typename T = unsigned long> __forceinline static T FadeStartTime() { return ( T ) 0xAD8; }
      template<typename T = unsigned long> __forceinline static T FadeEndTime() { return ( T ) 0xADC; }
      template<typename T = unsigned long> __forceinline static T MinColor() { return ( T ) 0xAE4; }
      template<typename T = unsigned long> __forceinline static T MaxColor() { return ( T ) 0xAF0; }
      template<typename T = unsigned long> __forceinline static T CurrentStage() { return ( T ) 0xAC4; }
   };
};
