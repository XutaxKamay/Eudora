...
#ifndef SDK_CPhysicsPropMultiplayer
#define SDK_CPhysicsPropMultiplayer
#pragma once
...
class CPhysicsPropMultiplayer
{
 public:
   ...
   class DT_PhysicsPropMultiplayer
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T iPhysicsMode() { return ( T ) 0x29B4; }
      template<typename T = unsigned long> __forceinline static T fMass() { return ( T ) 0x29B8; }
      template<typename T = unsigned long> __forceinline static T collisionMins() { return ( T ) 0x29BC; }
      template<typename T = unsigned long> __forceinline static T collisionMaxs() { return ( T ) 0x29C8; }
   };
};
