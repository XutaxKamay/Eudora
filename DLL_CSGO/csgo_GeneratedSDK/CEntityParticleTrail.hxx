...
#ifndef SDK_CEntityParticleTrail
#define SDK_CEntityParticleTrail
#pragma once
 ...
 public:
   ...
   class DT_EntityParticleTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T iMaterialName() { return ( T ) 0xAC0; }

      class DT_EntityParticleTrailInfo
      {
       public:

         template<typename T = unsigned long> __forceinline static T flLifetime() { return ( T ) 0xACC; }
         template<typename T = unsigned long> __forceinline static T flStartSize() { return ( T ) 0xAD0; }
         template<typename T = unsigned long> __forceinline static T flEndSize() { return ( T ) 0xAD4; }
      };

      template<typename T = unsigned long> __forceinline static T hConstraintEntity() { return ( T ) 0xAD8; }
   };
};
