...
#ifndef SDK_CPrecipitation
#define SDK_CPrecipitation
#pragma once
 ...
 public:
   ...
   class DT_Precipitation
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nPrecipType() { return ( T ) 0xA00; }
   };
};
