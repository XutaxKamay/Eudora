...
#ifndef SDK_CTEBeamEntPoint
#define SDK_CTEBeamEntPoint
#pragma once
 ...
 public:
   ...
   class DT_TEBeamEntPoint
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T vecStartPoint() { return ( T ) 0x54; }
      template<typename T = unsigned long> __forceinline static T vecEndPoint() { return ( T ) 0x60; }
   };
};
