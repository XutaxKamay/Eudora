...
#ifndef SDK_CDynamicLight
#define SDK_CDynamicLight
#pragma once
 ...
 public:
   ...
   class DT_DynamicLight
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T Flags() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T LightStyle() { return ( T ) 0x9D9; }
      template<typename T = unsigned long> __forceinline static T Radius() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T Exponent() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T InnerAngle() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T OuterAngle() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T SpotRadius() { return ( T ) 0x9EC; }
   };
};
