...
#ifndef SDK_SmokeTrail
#define SDK_SmokeTrail
#pragma once
 ...
 public:
   ...
   class DT_SmokeTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T SpawnRate() { return ( T ) 0xAC4; }
      template<typename T = unsigned long> __forceinline static T StartColor() { return ( T ) 0xAC8; }
      template<typename T = unsigned long> __forceinline static T EndColor() { return ( T ) 0xAD4; }
      template<typename T = unsigned long> __forceinline static T ParticleLifetime() { return ( T ) 0xAE4; }
      template<typename T = unsigned long> __forceinline static T StopEmitTime() { return ( T ) 0xAE8; }
      template<typename T = unsigned long> __forceinline static T MinSpeed() { return ( T ) 0xAEC; }
      template<typename T = unsigned long> __forceinline static T MaxSpeed() { return ( T ) 0xAF0; }
      template<typename T = unsigned long> __forceinline static T MinDirectedSpeed() { return ( T ) 0xAF4; }
      template<typename T = unsigned long> __forceinline static T MaxDirectedSpeed() { return ( T ) 0xAF8; }
      template<typename T = unsigned long> __forceinline static T StartSize() { return ( T ) 0xAFC; }
      template<typename T = unsigned long> __forceinline static T EndSize() { return ( T ) 0xB00; }
      template<typename T = unsigned long> __forceinline static T SpawnRadius() { return ( T ) 0xB04; }
      template<typename T = unsigned long> __forceinline static T bEmit() { return ( T ) 0xB14; }
      template<typename T = unsigned long> __forceinline static T nAttachment() { return ( T ) 0xB18; }
      template<typename T = unsigned long> __forceinline static T Opacity() { return ( T ) 0xAE0; }
   };
};
