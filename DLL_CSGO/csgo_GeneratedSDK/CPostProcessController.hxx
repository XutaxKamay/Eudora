...
#ifndef SDK_CPostProcessController
#define SDK_CPostProcessController
#pragma once
 ...
 public:
   ...
   class DT_PostProcessController
   {
    public:
      ...
      class m_flPostProcessParameters
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T _004() { return ( T ) 0x9E8; }
         template<typename T = unsigned long> __forceinline static T _005() { return ( T ) 0x9EC; }
         template<typename T = unsigned long> __forceinline static T _006() { return ( T ) 0x9F0; }
         template<typename T = unsigned long> __forceinline static T _007() { return ( T ) 0x9F4; }
         template<typename T = unsigned long> __forceinline static T _008() { return ( T ) 0x9F8; }
         template<typename T = unsigned long> __forceinline static T _009() { return ( T ) 0x9FC; }
         template<typename T = unsigned long> __forceinline static T _010() { return ( T ) 0xA00; }
      };

      template<typename T = unsigned long> __forceinline static T bMaster() { return ( T ) 0xA04; }
   };
};
