 ...
 public:
   ...
   class DT_World
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flWaveHeight() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T WorldMins() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T WorldMaxs() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T bStartDark() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T flMaxOccludeeArea() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T flMinOccluderArea() { return ( T ) 0x9FC; }
      template<typename T = unsigned long> __forceinline static T flMaxPropScreenSpaceWidth() { return ( T ) 0xA04; }
      template<typename T = unsigned long> __forceinline static T flMinPropScreenSpaceWidth() { return ( T ) 0xA00; }
      template<typename T = unsigned long> __forceinline static T iszDetailSpriteMaterial() { return ( T ) 0xA10; }
      template<typename T = unsigned long> __forceinline static T bColdWorld() { return ( T ) 0xA08; }
      template<typename T = unsigned long> __forceinline static T iTimeOfDay() { return ( T ) 0xA0C; }
   };
};
