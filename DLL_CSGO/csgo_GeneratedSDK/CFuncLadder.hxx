...
#ifndef SDK_CFuncLadder
#define SDK_CFuncLadder
#pragma once
 ...
 public:
   ...
   class DT_FuncLadder
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T vecPlayerMountPositionTop() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T vecPlayerMountPositionBottom() { return ( T ) 0xA04; }
      template<typename T = unsigned long> __forceinline static T vecLadderDir() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bFakeLadder() { return ( T ) 0xA11; }
   };
};
