...
#ifndef SDK_CParticlePerformanceMonitor
#define SDK_CParticlePerformanceMonitor
#pragma once
...
class CParticlePerformanceMonitor
{
 public:
   ...
   class DT_ParticlePerformanceMonitor
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bMeasurePerf() { return ( T ) 0x9D9; }
      template<typename T = unsigned long> __forceinline static T bDisplayPerf() { return ( T ) 0x9D8; }
   };
};
