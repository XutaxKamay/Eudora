...
#ifndef SDK_CEntityFreezing
#define SDK_CEntityFreezing
#pragma once
 ...
 public:
   ...
   class DT_EntityFreezing
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T vFreezingOrigin() { return ( T ) 0x9D8; }

      class m_flFrozenPerHitbox
      {
       public:
      ...
      template<typename T = unsigned long> __forceinline static T flFrozen() { return ( T ) 0xAAC; }
      template<typename T = unsigned long> __forceinline static T bFinishFreezing() { return ( T ) 0xAB0; }
   };
};
