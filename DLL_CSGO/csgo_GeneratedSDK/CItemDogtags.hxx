...
#ifndef SDK_CItemDogtags
#define SDK_CItemDogtags
#pragma once
 ...
 public:
   ...
   class DT_ItemDogtags
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T OwningPlayer() { return ( T ) 0x3410; }
      template<typename T = unsigned long> __forceinline static T KillingPlayer() { return ( T ) 0x3414; }
   };
};
