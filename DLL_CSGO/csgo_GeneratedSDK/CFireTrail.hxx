...
#ifndef SDK_CFireTrail
#define SDK_CFireTrail
#pragma once
 ...
 public:
   ...
   class DT_FireTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nAttachment() { return ( T ) 0xAC4; }
      template<typename T = unsigned long> __forceinline static T flLifetime() { return ( T ) 0xAC8; }
   };
};
