 ...
 public:
   ...
   class DT_CHostage
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T isRescued() { return ( T ) 0x2F20; }
      template<typename T = unsigned long> __forceinline static T jumpedThisFrame() { return ( T ) 0x2F21; }
      template<typename T = unsigned long> __forceinline static T iHealth() { return ( T ) 0xFC; }
      template<typename T = unsigned long> __forceinline static T iMaxHealth() { return ( T ) 0x2F08; }
      ...
      template<typename T = unsigned long> __forceinline static T nHostageState() { return ( T ) 0x2F24; }
      template<typename T = unsigned long> __forceinline static T flRescueStartTime() { return ( T ) 0x2F28; }
      template<typename T = unsigned long> __forceinline static T flGrabSuccessTime() { return ( T ) 0x2F2C; }
      template<typename T = unsigned long> __forceinline static T flDropStartTime() { return ( T ) 0x2F30; }
      template<typename T = unsigned long> __forceinline static T vel() { return ( T ) 0x2F14; }
      template<typename T = unsigned long> __forceinline static T leader() { return ( T ) 0x2F10; }
   };
};
