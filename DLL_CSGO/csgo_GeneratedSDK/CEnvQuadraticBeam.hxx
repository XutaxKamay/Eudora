...
#ifndef SDK_CEnvQuadraticBeam
#define SDK_CEnvQuadraticBeam
#pragma once
 ...
 public:
   ...
   class DT_QuadraticBeam
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T targetPosition() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T controlPosition() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T scrollRate() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T flWidth() { return ( T ) 0x9F4; }
   };
};
