...
#ifndef SDK_CPlantedC4
#define SDK_CPlantedC4
#pragma once
 ...
 public:
   ...
   class DT_PlantedC4
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bBombTicking() { return ( T ) 0x2970; }
      template<typename T = unsigned long> __forceinline static T flC4Blow() { return ( T ) 0x297C; }
      template<typename T = unsigned long> __forceinline static T flTimerLength() { return ( T ) 0x2980; }
      template<typename T = unsigned long> __forceinline static T flDefuseLength() { return ( T ) 0x2990; }
      template<typename T = unsigned long> __forceinline static T flDefuseCountDown() { return ( T ) 0x2994; }
      template<typename T = unsigned long> __forceinline static T bBombDefused() { return ( T ) 0x2998; }
      template<typename T = unsigned long> __forceinline static T hBombDefuser() { return ( T ) 0x299C; }
   };
};
