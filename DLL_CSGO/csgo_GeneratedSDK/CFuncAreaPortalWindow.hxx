...
#ifndef SDK_CFuncAreaPortalWindow
#define SDK_CFuncAreaPortalWindow
#pragma once
 ...
 public:
   ...
   class DT_FuncAreaPortalWindow
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flFadeDist() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T flTranslucencyLimit() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T iBackgroundModelIndex() { return ( T ) 0x9E4; }
   };
};
