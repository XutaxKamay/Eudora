...
#ifndef SDK_CFunc_LOD
#define SDK_CFunc_LOD
#pragma once
 ...
 public:
   ...
   class DT_Func_LOD
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nDisappearMinDist() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T nDisappearMaxDist() { return ( T ) 0x9DC; }
   };
};
