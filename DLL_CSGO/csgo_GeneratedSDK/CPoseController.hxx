...
#ifndef SDK_CPoseController
#define SDK_CPoseController
#pragma once
    ...
    public:
      ...
      class m_hProps
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T _000() { return ( T ) 0x9D8; }
         template<typename T = unsigned long> __forceinline static T _001() { return ( T ) 0x9DC; }
         template<typename T = unsigned long> __forceinline static T _002() { return ( T ) 0x9E0; }
         template<typename T = unsigned long> __forceinline static T _003() { return ( T ) 0x9E4; }
      };
      ...
      class m_chPoseIndex
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T _000() { return ( T ) 0x9E8; }
         template<typename T = unsigned long> __forceinline static T _001() { return ( T ) 0x9E9; }
         template<typename T = unsigned long> __forceinline static T _002() { return ( T ) 0x9EA; }
         template<typename T = unsigned long> __forceinline static T _003() { return ( T ) 0x9EB; }
      };

      template<typename T = unsigned long> __forceinline static T bPoseValueParity() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T fPoseValue() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T fInterpolationTime() { return ( T ) 0x9F4; }
      template<typename T = unsigned long> __forceinline static T bInterpolationWrap() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T fCycleFrequency() { return ( T ) 0x9FC; }
      template<typename T = unsigned long> __forceinline static T nFModType() { return ( T ) 0xA00; }
      template<typename T = unsigned long> __forceinline static T fFModTimeOffset() { return ( T ) 0xA04; }
      template<typename T = unsigned long> __forceinline static T fFModRate() { return ( T ) 0xA08; }
      template<typename T = unsigned long> __forceinline static T fFModAmplitude() { return ( T ) 0xA0C; }
   };
};
