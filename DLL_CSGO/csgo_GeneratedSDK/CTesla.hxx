 ...
 public:
   ...
   class DT_Tesla
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T SoundName() { return ( T ) 0xA00; }
      template<typename T = unsigned long> __forceinline static T iszSpriteName() { return ( T ) 0xA40; }
   };
};
