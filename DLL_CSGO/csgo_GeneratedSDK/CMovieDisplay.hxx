...
#ifndef SDK_CMovieDisplay
#define SDK_CMovieDisplay
#pragma once
 ...
 public:
   ...
   class DT_MovieDisplay
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bLooping() { return ( T ) 0x9D9; }
      template<typename T = unsigned long> __forceinline static T szMovieFilename() { return ( T ) 0x9DA; }
      template<typename T = unsigned long> __forceinline static T szGroupName() { return ( T ) 0xA5A; }
      template<typename T = unsigned long> __forceinline static T bStretchToFill() { return ( T ) 0xADA; }
      template<typename T = unsigned long> __forceinline static T bForcedSlave() { return ( T ) 0xADB; }
      template<typename T = unsigned long> __forceinline static T bUseCustomUVs() { return ( T ) 0xADC; }
      template<typename T = unsigned long> __forceinline static T flUMin() { return ( T ) 0xAE0; }
      template<typename T = unsigned long> __forceinline static T flUMax() { return ( T ) 0xAE4; }
      template<typename T = unsigned long> __forceinline static T flVMin() { return ( T ) 0xAE8; }
      template<typename T = unsigned long> __forceinline static T flVMax() { return ( T ) 0xAEC; }
   };
};
