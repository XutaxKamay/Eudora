...
#ifndef SDK_CWaterLODControl
#define SDK_CWaterLODControl
#pragma once
 ...
 public:
   ...
   class DT_WaterLODControl
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flCheapWaterStartDistance() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T flCheapWaterEndDistance() { return ( T ) 0x9DC; }
   };
};
