...
#ifndef SDK_CBoneFollower
#define SDK_CBoneFollower
#pragma once
 ...
 public:
   ...
   class DT_BoneFollower
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T modelIndex() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T solidIndex() { return ( T ) 0x9DC; }
   };
};
