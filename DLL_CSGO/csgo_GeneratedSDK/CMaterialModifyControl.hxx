...
#ifndef SDK_CMaterialModifyControl
#define SDK_CMaterialModifyControl
#pragma once
 ...
 public:
   ...
   class DT_MaterialModifyControl
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T szMaterialName() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T szMaterialVar() { return ( T ) 0xAD7; }
      template<typename T = unsigned long> __forceinline static T szMaterialVarValue() { return ( T ) 0xBD6; }
      template<typename T = unsigned long> __forceinline static T iFrameStart() { return ( T ) 0xCE0; }
      template<typename T = unsigned long> __forceinline static T iFrameEnd() { return ( T ) 0xCE4; }
      template<typename T = unsigned long> __forceinline static T bWrap() { return ( T ) 0xCE8; }
      template<typename T = unsigned long> __forceinline static T flFramerate() { return ( T ) 0xCEC; }
      template<typename T = unsigned long> __forceinline static T bNewAnimCommandsSemaphore() { return ( T ) 0xCF0; }
      template<typename T = unsigned long> __forceinline static T flFloatLerpStartValue() { return ( T ) 0xCF4; }
      template<typename T = unsigned long> __forceinline static T flFloatLerpEndValue() { return ( T ) 0xCF8; }
      template<typename T = unsigned long> __forceinline static T flFloatLerpTransitionTime() { return ( T ) 0xCFC; }
      template<typename T = unsigned long> __forceinline static T bFloatLerpWrap() { return ( T ) 0xD00; }
      template<typename T = unsigned long> __forceinline static T nModifyMode() { return ( T ) 0xD08; }
   };
};
