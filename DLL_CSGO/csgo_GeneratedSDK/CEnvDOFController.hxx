...
#ifndef SDK_CEnvDOFController
#define SDK_CEnvDOFController
#pragma once
 ...
 public:
   ...
   class DT_EnvDOFController
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bDOFEnabled() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T flNearBlurDepth() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T flNearFocusDepth() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T flFarFocusDepth() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T flFarBlurDepth() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T flNearBlurRadius() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flFarBlurRadius() { return ( T ) 0x9F0; }
   };
};
