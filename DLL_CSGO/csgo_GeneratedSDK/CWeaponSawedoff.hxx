...
#ifndef SDK_CWeaponSawedoff
#define SDK_CWeaponSawedoff
#pragma once
 ...
 public:
   ...
   class DT_WeaponSawedoff
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T reloadState() { return ( T ) 0x3364; }
   };
};
