...
#ifndef SDK_CPhysBoxMultiplayer
#define SDK_CPhysBoxMultiplayer
#pragma once
    ...
    public:
      ...
      class DT_PhysBox
      {
       public:
         ...
         template<typename T = unsigned long> __forceinline static T mass() { return ( T ) 0x9D8; }
      };

      template<typename T = unsigned long> __forceinline static T iPhysicsMode() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T fMass() { return ( T ) 0x9E8; }
   };
};
