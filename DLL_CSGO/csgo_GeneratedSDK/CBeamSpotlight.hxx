...
#ifndef SDK_CBeamSpotlight
#define SDK_CBeamSpotlight
#pragma once
 ...
 public:
   ...
   class DT_BeamSpotlight
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nHaloIndex() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bSpotlightOn() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T bHasDynamicLight() { return ( T ) 0x9E5; }
      template<typename T = unsigned long> __forceinline static T flSpotlightMaxLength() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T flSpotlightGoalWidth() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T flHDRColorScale() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T nRotationAxis() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T flRotationSpeed() { return ( T ) 0x9E0; }
   };
};
