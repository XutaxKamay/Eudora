...
#ifndef SDK_CCascadeLight
#define SDK_CCascadeLight
#pragma once
 ...
 public:
   ...
   class DT_CascadeLight
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T envLightShadowDirection() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T bEnabled() { return ( T ) 0x9F0; }
      template<typename T = unsigned long> __forceinline static T bUseLightEnvAngles() { return ( T ) 0x9F1; }
      template<typename T = unsigned long> __forceinline static T LightColor() { return ( T ) 0x9F2; }
      template<typename T = unsigned long> __forceinline static T LightColorScale() { return ( T ) 0x9F8; }
      template<typename T = unsigned long> __forceinline static T flMaxShadowDist() { return ( T ) 0x9FC; }
   };
};
