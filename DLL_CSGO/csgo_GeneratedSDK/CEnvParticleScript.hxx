...
#ifndef SDK_CEnvParticleScript
#define SDK_CEnvParticleScript
#pragma once
 ...
 public:
   ...
   class DT_EnvParticleScript
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flSequenceScale() { return ( T ) 0x2A54; }
   };
};
