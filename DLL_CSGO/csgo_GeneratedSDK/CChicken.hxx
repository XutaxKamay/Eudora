 ...
 public:
   ...
   class DT_CChicken
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T jumpedThisFrame() { return ( T ) 0x29D8; }
      template<typename T = unsigned long> __forceinline static T leader() { return ( T ) 0x29DC; }
   };
};
