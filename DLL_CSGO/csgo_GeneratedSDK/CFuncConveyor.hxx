...
#ifndef SDK_CFuncConveyor
#define SDK_CFuncConveyor
#pragma once
 ...
 public:
   ...
   class DT_FuncConveyor
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flConveyorSpeed() { return ( T ) 0x9D8; }
   };
};
