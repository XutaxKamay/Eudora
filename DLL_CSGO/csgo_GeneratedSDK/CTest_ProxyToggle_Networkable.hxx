...
#ifndef SDK_CTest_ProxyToggle_Networkable
#define SDK_CTest_ProxyToggle_Networkable
#pragma once
 ...
 public:
   ...
   class DT_ProxyToggle
   {
    public:
      ...
      class DT_ProxyToggle_ProxiedData
      {
       public:

         template<typename T = unsigned long> __forceinline static T WithProxy() { return ( T ) 0x9D8; }
      };
   };
};
