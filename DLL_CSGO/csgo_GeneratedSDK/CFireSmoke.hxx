...
#ifndef SDK_CFireSmoke
#define SDK_CFireSmoke
#pragma once
 ...
 public:
   ...
   class DT_FireSmoke
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T nFlameModelIndex() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T nFlameFromAboveModelIndex() { return ( T ) 0x9EC; }
   };
};
