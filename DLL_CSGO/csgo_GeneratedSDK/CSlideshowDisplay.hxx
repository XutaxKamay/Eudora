...
#ifndef SDK_CSlideshowDisplay
#define SDK_CSlideshowDisplay
#pragma once
 ...
 public:
   ...
   class DT_SlideshowDisplay
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bEnabled() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T szDisplayText() { return ( T ) 0x9D9; }
      template<typename T = unsigned long> __forceinline static T szSlideshowDirectory() { return ( T ) 0xA59; }

      class m_chCurrentSlideLists
      {
       public:

         template<typename T = unsigned long> __forceinline static T _000() { return ( T ) 0xAF0; }
         template<typename T = unsigned long> __forceinline static T _001() { return ( T ) 0xAF1; }
         template<typename T = unsigned long> __forceinline static T _002() { return ( T ) 0xAF2; }
         template<typename T = unsigned long> __forceinline static T _003() { return ( T ) 0xAF3; }
         template<typename T = unsigned long> __forceinline static T _004() { return ( T ) 0xAF4; }
         template<typename T = unsigned long> __forceinline static T _005() { return ( T ) 0xAF5; }
         template<typename T = unsigned long> __forceinline static T _006() { return ( T ) 0xAF6; }
         template<typename T = unsigned long> __forceinline static T _007() { return ( T ) 0xAF7; }
         template<typename T = unsigned long> __forceinline static T _008() { return ( T ) 0xAF8; }
         template<typename T = unsigned long> __forceinline static T _009() { return ( T ) 0xAF9; }
         template<typename T = unsigned long> __forceinline static T _010() { return ( T ) 0xAFA; }
         template<typename T = unsigned long> __forceinline static T _011() { return ( T ) 0xAFB; }
         template<typename T = unsigned long> __forceinline static T _012() { return ( T ) 0xAFC; }
         template<typename T = unsigned long> __forceinline static T _013() { return ( T ) 0xAFD; }
         template<typename T = unsigned long> __forceinline static T _014() { return ( T ) 0xAFE; }
         template<typename T = unsigned long> __forceinline static T _015() { return ( T ) 0xAFF; }
      };

      template<typename T = unsigned long> __forceinline static T fMinSlideTime() { return ( T ) 0xB08; }
      template<typename T = unsigned long> __forceinline static T fMaxSlideTime() { return ( T ) 0xB0C; }
      template<typename T = unsigned long> __forceinline static T iCycleType() { return ( T ) 0xB14; }
      template<typename T = unsigned long> __forceinline static T bNoListRepeats() { return ( T ) 0xB18; }
   };
};
