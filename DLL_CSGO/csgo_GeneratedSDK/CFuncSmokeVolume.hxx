...
#ifndef SDK_CFuncSmokeVolume
#define SDK_CFuncSmokeVolume
#pragma once
 ...
 public:
   ...
   class DT_FuncSmokeVolume
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T Color1() { return ( T ) 0xAC4; }
      template<typename T = unsigned long> __forceinline static T Color2() { return ( T ) 0xAC8; }
      template<typename T = unsigned long> __forceinline static T MaterialName() { return ( T ) 0xACC; }
      template<typename T = unsigned long> __forceinline static T ParticleDrawWidth() { return ( T ) 0xBCC; }
      template<typename T = unsigned long> __forceinline static T ParticleSpacingDistance() { return ( T ) 0xBD0; }
      template<typename T = unsigned long> __forceinline static T DensityRampSpeed() { return ( T ) 0xBD4; }
      template<typename T = unsigned long> __forceinline static T RotationSpeed() { return ( T ) 0xBD8; }
      template<typename T = unsigned long> __forceinline static T MovementSpeed() { return ( T ) 0xBDC; }
      template<typename T = unsigned long> __forceinline static T Density() { return ( T ) 0xBE0; }
      template<typename T = unsigned long> __forceinline static T maxDrawDistance() { return ( T ) 0xBE4; }
      template<typename T = unsigned long> __forceinline static T spawnflags() { return ( T ) 0xBE8; }
