...
#ifndef SDK_CSunlightShadowControl
#define SDK_CSunlightShadowControl
#pragma once
...
class CSunlightShadowControl
{
 public:
   ...
   class DT_SunlightShadowControl
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T shadowDirection() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bEnabled() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T TextureName() { return ( T ) 0x9E5; }
      template<typename T = unsigned long> __forceinline static T LightColor() { return ( T ) 0xAF0; }
      template<typename T = unsigned long> __forceinline static T flColorTransitionTime() { return ( T ) 0xB04; }
      template<typename T = unsigned long> __forceinline static T flSunDistance() { return ( T ) 0xB08; }
      template<typename T = unsigned long> __forceinline static T flFOV() { return ( T ) 0xB0C; }
      template<typename T = unsigned long> __forceinline static T flNearZ() { return ( T ) 0xB10; }
      template<typename T = unsigned long> __forceinline static T flNorthOffset() { return ( T ) 0xB14; }
      template<typename T = unsigned long> __forceinline static T bEnableShadows() { return ( T ) 0xB18; }
   };
};
