 ...
 public:
   ...
   class DT_Plasma
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T flStartScale() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T flScale() { return ( T ) 0x9DC; }
      template<typename T = unsigned long> __forceinline static T flScaleTime() { return ( T ) 0x9E0; }
      template<typename T = unsigned long> __forceinline static T nFlags() { return ( T ) 0x9E4; }
      template<typename T = unsigned long> __forceinline static T nPlasmaModelIndex() { return ( T ) 0x9E8; }
      template<typename T = unsigned long> __forceinline static T nPlasmaModelIndex2() { return ( T ) 0x9EC; }
      template<typename T = unsigned long> __forceinline static T nGlowModelIndex() { return ( T ) 0x9F0; }
   };
};
