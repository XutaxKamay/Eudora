...
#ifndef SDK_DustTrail
#define SDK_DustTrail
#pragma once
 ...
 public:
   ...
   class DT_DustTrail
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T Color() { return ( T ) 0xAC8; }
      template<typename T = unsigned long> __forceinline static T ParticleLifetime() { return ( T ) 0xAD8; }
      template<typename T = unsigned long> __forceinline static T StopEmitTime() { return ( T ) 0xAE0; }
      template<typename T = unsigned long> __forceinline static T MinSpeed() { return ( T ) 0xAE4; }
      template<typename T = unsigned long> __forceinline static T MaxSpeed() { return ( T ) 0xAE8; }
      template<typename T = unsigned long> __forceinline static T MinDirectedSpeed() { return ( T ) 0xAEC; }
      template<typename T = unsigned long> __forceinline static T MaxDirectedSpeed() { return ( T ) 0xAF0; }
      ...
      template<typename T = unsigned long> __forceinline static T Opacity() { return ( T ) 0xAD4; }
   };
};
