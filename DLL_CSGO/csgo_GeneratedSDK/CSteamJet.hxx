...
#ifndef SDK_CSteamJet
#define SDK_CSteamJet
#pragma once
 ...
 public:
   ...
   class DT_SteamJet
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T SpreadSpeed() { return ( T ) 0xAC4; }
      template<typename T = unsigned long> __forceinline static T Speed() { return ( T ) 0xAC8; }
      template<typename T = unsigned long> __forceinline static T StartSize() { return ( T ) 0xACC; }
      template<typename T = unsigned long> __forceinline static T EndSize() { return ( T ) 0xAD0; }
      template<typename T = unsigned long> __forceinline static T Rate() { return ( T ) 0xAD4; }
      template<typename T = unsigned long> __forceinline static T JetLength() { return ( T ) 0xAD8; }
      template<typename T = unsigned long> __forceinline static T bEmit() { return ( T ) 0xADC; }
      template<typename T = unsigned long> __forceinline static T bFaceLeft() { return ( T ) 0xAE4; }
      template<typename T = unsigned long> __forceinline static T nType() { return ( T ) 0xAE0; }
      template<typename T = unsigned long> __forceinline static T spawnflags() { return ( T ) 0xAE8; }
      template<typename T = unsigned long> __forceinline static T flRollSpeed() { return ( T ) 0xAEC; }
   };
};
