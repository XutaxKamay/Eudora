...
#ifndef SDK_CHandleTest
#define SDK_CHandleTest
#pragma once
 ...
 public:
   ...
   class DT_HandleTest
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T Handle() { return ( T ) 0x9D8; }
      template<typename T = unsigned long> __forceinline static T bSendHandle() { return ( T ) 0x9DC; }
   };
};
