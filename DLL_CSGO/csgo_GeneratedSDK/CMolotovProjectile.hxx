...
#ifndef SDK_CMolotovProjectile
#define SDK_CMolotovProjectile
#pragma once
 ...
 public:
   ...
   class DT_MolotovProjectile
   {
    public:
      ...
      template<typename T = unsigned long> __forceinline static T bIsIncGrenade() { return ( T ) 0x29D0; }
   };
};
