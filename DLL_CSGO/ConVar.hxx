...
typedef Pointer( *CreateClientClassFn )( int entnum , int serialNum );
typedef Pointer( *CreateEventFn )( );
...
public:
    ...
    {
    public:
        __forceinline Iterator( ICvar *icvar )
        {
            m_pIter = icvar->FactoryInternalIterator();
        }
        __forceinline ~Iterator( void )
        {
            //MemAllocValve->Free( m_pIter );
        }
        __forceinline void	SetFirst( void )
        {
            m_pIter->SetFirst();
        }
        __forceinline void	Next( void )
        {
            m_pIter->Next();
        }
        __forceinline bool	IsValid( void )
        {
            return m_pIter->IsValid();
        }
        __forceinline ConCommandBase *Get( void )
        {
            return m_pIter->Get();
        }
